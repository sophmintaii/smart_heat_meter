    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    (uint8)'P', (uint8)'S', (uint8)'o', (uint8)'C', (uint8)' ', (uint8)'C', (uint8)'r', (uint8)'e', (uint8)'a',
    (uint8)'t', (uint8)'o', (uint8)'r', (uint8)' ', (uint8)'3', (uint8)'.', (uint8)'1',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0005u, (void *)&cyBle_attValues[27] }, /* Temperature Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0001u, (void *)&cyBle_attValues[32] }, /* Temperature Type */
    { 0x0005u, (void *)&cyBle_attValues[33] }, /* Intermediate Temperature */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[38] }, /* Measurement Interval */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* Client Characteristic Configuration */
    { 0x0004u, (void *)&cyBle_attValues[40] }, /* Valid Range */
    { 0x0015u, (void *)&cyBle_attValues[44] }, /* Manufacturer Name String */
    { 0x0003u, (void *)&cyBle_attValues[65] }, /* Model Number String */
    { 0x0002u, (void *)&cyBle_attValues[68] }, /* Serial Number String */
    { 0x000Fu, (void *)&cyBle_attValues[70] }, /* Hardware Revision String */
    { 0x0002u, (void *)&cyBle_attValues[85] }, /* Firmware Revision String */
    { 0x0010u, (void *)&cyBle_attValues[87] }, /* Software Revision String */
    { 0x0008u, (void *)&cyBle_attValues[103] }, /* System ID */
    { 0x0001u, (void *)&cyBle_attValues[111] }, /* IEEE 11073-20601 Regulatory Certification Data List */
    { 0x0007u, (void *)&cyBle_attValues[112] }, /* PnP ID */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x2Bu] = {
    ...
    { 0x0011u, 0x2A1Du /* Temperature Type                    */, 0x01020001u /* rd     */, 0x0011u, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf    */, 0x0014u, {{0x2A1Eu, NULL}}                           },
    { 0x0013u, 0x2A1Eu /* Intermediate Temperature            */, 0x01100000u /* ntf    */, 0x0014u, {{0x0005u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr  */, 0x0018u, {{0x2A21u, NULL}}                           },
    { 0x0016u, 0x2A21u /* Measurement Interval                */, 0x010A0101u /* rd,wr  */, 0x0018u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0017u, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0018u, 0x2906u /* Valid Range                         */, 0x01020001u /* rd     */, 0x0018u, {{0x0004u, (void *)&cyBle_attValuesLen[12]}} },
    ...
    { 0x001Bu, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd     */, 0x001Bu, {{0x0015u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Cu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x001Du, {{0x2A24u, NULL}}                           },
    { 0x001Du, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd     */, 0x001Du, {{0x0003u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x001Eu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x001Fu, {{0x2A25u, NULL}}                           },
    { 0x001Fu, 0x2A25u /* Serial Number String                */, 0x01020001u /* rd     */, 0x001Fu, {{0x0002u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0020u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0021u, {{0x2A27u, NULL}}                           },
    { 0x0021u, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd     */, 0x0021u, {{0x000Fu, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0022u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0023u, {{0x2A26u, NULL}}                           },
    { 0x0023u, 0x2A26u /* Firmware Revision String            */, 0x01020001u /* rd     */, 0x0023u, {{0x0002u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0024u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0025u, {{0x2A28u, NULL}}                           },
    { 0x0025u, 0x2A28u /* Software Revision String            */, 0x01020001u /* rd     */, 0x0025u, {{0x0010u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x0026u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0027u, {{0x2A23u, NULL}}                           },
    { 0x0027u, 0x2A23u /* System ID                           */, 0x01020001u /* rd     */, 0x0027u, {{0x0008u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x0028u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0029u, {{0x2A2Au, NULL}}                           },
    { 0x0029u, 0x2A2Au /* IEEE 11073-20601 Regulatory Certifi */, 0x01020001u /* rd     */, 0x0029u, {{0x0001u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x002Au, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x002Bu, {{0x2A50u, NULL}}                           },
    { 0x002Bu, 0x2A50u /* PnP ID                              */, 0x01020001u /* rd     */, 0x002Bu, {{0x0007u, (void *)&cyBle_attValuesLen[21]}} },
};
