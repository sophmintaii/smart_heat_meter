...
#define UART_BT_INTERNAL_CLOCK_USED            (0u)
...
#define UART_BT_TXBUFFERSIZE                   (40u)
#define UART_BT_RXBUFFERSIZE                   (4u)
...
#define UART_BT_BIT_CENTER                         (UART_BT_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 UART_BT_initVar;
    ...
    extern volatile uint8 UART_BT_txBuffer[UART_BT_TXBUFFERSIZE];
    extern volatile uint8 UART_BT_txBufferRead;
    extern uint8 UART_BT_txBufferWrite;
#endif /* End UART_BT_TX_ENABLED */
#if( ( UART_BT_RX_ENABLED || UART_BT_HD_ENABLED ) && \
     (UART_BT_RXBUFFERSIZE > UART_BT_FIFO_LENGTH) )
    extern volatile uint8 UART_BT_rxBuffer[UART_BT_RXBUFFERSIZE];
...
#if (UART_BT_RXHW_ADDRESS_ENABLED)
    #define UART_BT_RXADDRESSMODE      (0u)
    #define UART_BT_RXHWADDRESS1       (0u)
    #define UART_BT_RXHWADDRESS2       (0u)
